...
## Installation
1. Download the script by clicking on the green button on top of your screen (<> Code -> Download ZIP). You can also download from the [releases](https://github.com/Path-to-Precision/p2p_Shop/releases).
